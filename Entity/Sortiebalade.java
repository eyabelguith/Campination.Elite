...
public class Sortiebalade extends Sortie {
    ...
    public Sortiebalade(int id_SB, String nom, java.sql.Date date_depart, java.sql.Date date_retour, int cinT, String nom_S) {
    ...
    @Override
    public String toString() {
        return "Sortiebalade{" + "id_SB=" + id_SB + ", Nom=" + nom + '}';
    }
