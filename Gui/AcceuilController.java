...
public class AcceuilController implements Initializable {
    ...
    private void gocamper(ActionEvent event) {
        ...
        try {
            Parent root = FXMLLoader.load(getClass().getResource("Interface Camper.fxml"));
            ...
            Logger.getLogger(InterfaceCamperController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
