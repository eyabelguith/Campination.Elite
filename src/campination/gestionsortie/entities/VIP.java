...
public class VIP {
    private int id_vip;
       private int cin ;//id_camper
        private int  nb_SS; //mel camper 
        private int   nb_SB; //mel camper 
        private int   nb_pt; //teb3a el vip bech tebda calcule 
            
 public VIP(){}

    public VIP(int id_vip, int cin, int nb_SS, int nb_SB, int nb_pt) {
        this.id_vip = id_vip;
        this.cin = cin;
        this.nb_SS = nb_SS;
        this.nb_SB = nb_SB;
    ...
    public String toString() {
        return "VIP{" + "id_vip=" + id_vip + ", cin=" + cin + ", nb_SS=" + nb_SS + ", nb_SB=" + nb_SB + ", nb_pt=" + nb_pt + '}';
    }
