...
public class Transporteur  {
    ...
    public Transporteur(String nom,int cin, int num_tel,String gouvernorat ,String moyenT, String matricule, int capacite,String role) {
        this.nom = nom;
    ...
    public String toString() {
        return "Transporteur{" + "nom=" + nom +"cin="+cin+ ", num_tel=" + num_tel + ", gouvernorat=" + gouvernorat + ", moyenT=" + moyenT + ", matricule=" + matricule + ", capacite=" + capacite + ", role=" + role + '}';
    }
